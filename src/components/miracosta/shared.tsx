...
export function MiracostaSection({
  id,
  bgColor,
  bgSpeed = 0.3,
  fadeTop,
...
interface MiracostaWaveProps {
  fill: string;
  flip?: boolean;
}

export function MiracostaWave({ fill, flip = false }: MiracostaWaveProps) {
  return (
...
interface MiracostaCardProps {
  children: ReactNode;
  style?: CSSProperties;
  delay?: number;
}

export function MiracostaCard({ children, style = {}, delay = 0 }: MiracostaCardProps) {
  return (
    <div
      className="reveal"
      style={{
...
export function MiracostaEyebrow({ children }: { children: ReactNode }) {
  return (
...
interface MiracostaPhotoPlaceholderProps {
  label: string;
  aspectRatio?: string;
  index: number;
}

export function MiracostaPhotoPlaceholder({
  label,
  aspectRatio = "3/4",
  index,
}: MiracostaPhotoPlaceholderProps) {
  const patterns = [
...
export function MiracostaPageStyles() {
  return (
    <style>{`
