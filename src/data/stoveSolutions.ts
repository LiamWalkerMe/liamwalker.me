export const designSpecs = [
  ...
  },
  {
    ...
    detail: 'There will be an app that monitors the status of the gas flowing to the stove and allows the user to shut off the stove.',
  },
  {
    title: 'Added to Stoves From Production Stage',
    detail: 'The device will be a product that can be added to stoves from the production stage, removing any interaction from stove users.',
  },
  {
    title: 'LED Indicator',
